# Phase 6B v8 Semantic Dependency Target Map Audit

## Summary

Total TDM rows: 472
Manual-review TDM rows: 45
TDM manual rows with READY status: 0
TDM manual rows missing reason: 0
Fixed-pricing proxy rows blocked: 10
...
seed_6b_02_fixed_pricing_model is not treated as an implicit first-child pricing anchor. Rows that select it as a general 6B.02 pricing-capability proxy remain manual-review blocked unless PRICING_ANCHOR_DECISION_ACCEPTED exists.
