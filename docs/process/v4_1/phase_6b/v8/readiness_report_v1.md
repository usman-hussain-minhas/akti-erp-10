...
Current status: PHASE_6B_V8_READY_FOR_TARGETED_MANUAL_REVIEW_WITH_BLOCKERS
Acceptance review allowed: false until manual blockers resolve.
Ticket-pack authorization: false
Ticket generation allowed: false
Ticket pack generation allowed: false
Ticket planning remains blocked unless separately approved after manual review.

## Blocker Registry

manual_blocker_registry_v1.json is the machine-readable blocker authority. Registry blocker count: 138. Every manual-review row or edge in v8 carries a registry-backed blocker_id.
