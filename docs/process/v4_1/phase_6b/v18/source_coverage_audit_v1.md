# Phase 6B v8 Source Coverage Audit
...
Source coverage remains version-preserved from v7. v8 changes blocker visibility and acceptance-boundary semantics only.
