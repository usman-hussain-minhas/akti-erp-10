# Spark Platform v4.1 6D Zero-Trust Gate Summary v1

Status: SPARK_PLATFORM_V4_1_PHASE_6D_ZERO_TRUST_GATE_READY_FOR_REVIEW
...
|---|---|
| phase | 6D |
| source_component_count | 10 |
| surface_count | 10 |
| subsurface_count | 59 |
| seed_count | 59 |
| dependency_extraction_edge_count | 277 |
| edge_distribution | hard_dependency=272 / deferred_with_reason=4 / conditional_dependency=1 / manual_review_required=0 |
...
| checkpoint_commit_sha | 8de1d71b766217371cba399a4a0c3a00a9763626 |
| ready_status | READY |
...
- allowed_dependency_phases: 6a, 6b, 6c
