# Spark Platform v4.1 6F Zero-Trust Gate Summary v1

Status: SPARK_PLATFORM_V4_1_PHASE_6F_ZERO_TRUST_GATE_READY_FOR_REVIEW
...
- Top-level seed dependency references: 128
- Root seeds: 0
...
| subsurface_count | 34 |
| seed_count | 34 |
| dependency_extraction_edge_count | 133 |
| edge_distribution | hard_dependency=128 / deferred_with_reason=1 / conditional_dependency=4 / manual_review_required=0 |
...
| checkpoint_commit_sha | b1578bd1eb72ba808101392137703406c9cc86ab |
| ready_status | READY |
...
- allowed_dependency_phases: 6a, 6b, 6c, 6d, 6e
