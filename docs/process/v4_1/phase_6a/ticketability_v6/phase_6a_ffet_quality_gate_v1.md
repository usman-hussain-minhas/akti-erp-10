...
## Phase 6A v6 ADL Reference Gate
...
- The six Saga/Event/DLQ edges corrected in root Phase 6A dependency truth carry the ratified ADL refs in this v6 FFET set.
