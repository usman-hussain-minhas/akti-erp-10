...
- Extraction edge counts are reported in dependency_extraction_audit_v1.md and are not mixed with seed dependency reference counts.
- Manifest-required missing dependencies: 0, excluding the documented service_manifest_contract bootstrap/self-trace exception.
