...
| `platform.data.controls.view` | Platform / Data Controls | Phase 5B1 | seeded | View honest Data Controls status surfaces. | manager, director, super-admin | View-only substrate; does not grant import/export/backup execution. |
