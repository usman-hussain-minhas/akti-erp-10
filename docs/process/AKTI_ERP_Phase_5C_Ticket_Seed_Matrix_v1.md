...
- Spark Genesis v0.2.1 seed-matrix audit checklist, frontend checklist, and failure patterns
...
| `P5C-SEED-052` | 5 | Workspace/platform services operational overview cards | Present workspace and platform service cards with real or unavailable states only. | `P5C-SEED-050` | `/app` screen contract | dashboard overview; platform status surface | frontend overview cards | reads use `GET /platform/status/overview`; no fake metric checks; screenshot checks | fake revenue, fake analytics, fake notifications | Operational overview status cards use approved status source only. |
...
| `P5C-SEED-054` | 5 | Data-controls/governance operational card | Present data-controls/governance state from the approved data-controls status source. | `P5C-SEED-052` | `/app` screen contract; data-controls component map | dashboard overview; data-controls status surface | frontend overview card | reads use `GET /platform/data-controls/status`; no fake governance status | fake import/export status, fake retention policy, fake access/audit controls | Keeps data controls on its own approved data source. |
...
| `P5C-SEED-092` | 9 | Workspace status interaction states | Validate workspace status card interaction after the status source exists. | `P5C-SEED-033` | workspace status card component contract | shell status component | frontend non-route status interaction | keyboard/focus checks; unavailable and loading state checks | fake status, fake service uptime, fake CRM pipeline status | Interaction seed stays on the workspace status ownership area. |
| `P5C-SEED-093` | 9 | Org badge dropdown interaction states | Validate org badge dropdown interaction after organization profile display exists. | `P5C-SEED-032` | org badge component contract | org badge component | frontend non-route org context interaction | keyboard/focus checks; org profile loading/error states | org switching implementation beyond approved read/display state, account-management rewrites | Interaction seed stays on the org badge ownership area. |
| `P5C-SEED-094` | 9 | Mobile shell interaction integration | Validate mobile shell interaction baseline after status, org badge, and notification affordances are shaped. | `P5C-SEED-033`, `P5C-SEED-091`, `P5C-SEED-092`, `P5C-SEED-093` | mobile shell component contract | mobile shell layout and navigation controls | frontend mobile shell interaction | mobile keyboard/tap/focus checks | mobile-only feature invention, unsupported navigation surfaces | Integration seed uses existing component sources and does not introduce new APIs. |
| `P5C-SEED-100` | 10 | Keyboard/focus/accessibility validation | Verify keyboard traversal, labels, focus rings, and states across implemented surfaces. | `P5C-SEED-094` | all route and component contracts | frontend shell and components | accessibility validation | focus/keyboard/a11y checks | inaccessible focus states | Future ticket must commit `docs/process/AKTI_ERP_Phase_5C_Accessibility_Validation_v1.md`. |
| `P5C-SEED-101` | 10 | Responsive/mobile validation | Verify mobile shell and component behavior. | `P5C-SEED-033`, `P5C-SEED-100` | mobile shell contract | shell and route components | responsive validation | mobile screenshots and no-overlap checks | mobile-only feature invention | Future ticket must commit `docs/process/AKTI_ERP_Phase_5C_Responsive_Mobile_Validation_v1.md` and depends directly on mobile shell baseline. |
| `P5C-SEED-102` | 10 | Dark and light screenshot acceptance | Capture and compare approved dark/light visual targets. | `P5C-SEED-101` | screenshot acceptance plan | screenshot tooling and frontend routes | visual QA evidence | dark desktop, light desktop, mobile screenshots | accept broken contrast, overlap, fake data, unsupported modules | Must cite `docs/process/AKTI_ERP_Phase_5C_Screenshot_Acceptance_Plan_v1.md` and commit screenshot evidence index. |
| `P5C-SEED-110` | 11 | Cross-surface no-fake validation | Prove no fake dashboards, modules, metrics, notifications, analytics, or revenue were introduced. | `P5C-SEED-102` | all control docs | frontend routes/components; docs | audit/validation | negative grep/static checks and screenshots | fake dashboards/modules/metrics | Future ticket must commit `docs/process/AKTI_ERP_Phase_5C_No_Fake_Surface_Validation_v1.md`. |
...
| `P5C-SEED-122` | 12 | Spark Genesis audit before ticket-pack creation | Run final Spark Genesis gate before ticket pack authoring. | `P5C-SEED-121` | Spark Genesis adoption and references | seed matrix, handoff, control docs | docs/audit | audit verdict before ticket pack | bypass Spark Genesis gate | Future ticket must commit `docs/process/AKTI_ERP_Phase_5C_Ticket_Pack_Readiness_Spark_Genesis_Audit_v1.md`; ticket pack may be created only after this audit passes. |
