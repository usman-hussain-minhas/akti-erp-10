# AKTI ERP Workflow Process Definition Standard v1
...
Create the execution-grade Phase 5A service/API contract standard for Workflow Process Definition Contract without drifting into Phase 5B runtime implementation.

### Decision / Policy

Workflow process definition contract describes workflow versions, states, transitions, guards, approvals, events, audit, and deprecation behavior.

### Required Rules

- Workflow definitions cannot redefine Gatekeeper outcomes.
- Definitions are versioned and tenant-aware where applicable.
- Runtime workflow engine is future work.
...
- Build workflow service against this contract.
- Gatekeeper validates process changes.
- Modules declare workflow dependencies.
