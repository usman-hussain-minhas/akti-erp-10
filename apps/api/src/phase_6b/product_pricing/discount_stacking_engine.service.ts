...
export class Phase6BDiscountStackingEngineService {
  evaluateStack(request: Phase6BDiscountStackRequest): Phase6BDiscountStackReceipt {
...
function assertValidDiscountStackRequest(request: Phase6BDiscountStackRequest): void {
