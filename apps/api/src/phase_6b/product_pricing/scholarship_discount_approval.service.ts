...
export class Phase6BScholarshipDiscountApprovalService {
  recordDecision(request: Phase6BScholarshipDiscountApprovalRequest): Phase6BScholarshipDiscountApprovalReceipt {
