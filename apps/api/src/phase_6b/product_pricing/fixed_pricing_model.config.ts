export type Phase6BFixedPricingModelInput = {
  ...
  source_seed_id?: 'seed_6b_02_fixed_pricing_model';
...
export type Phase6BFixedPricingModelResult = {
  accepted: boolean;
  normalized_amount_minor_units: number;
  normalized_currency_code: string;
  evidence: {
    seed_id: 'seed_6b_02_fixed_pricing_model';
  ...
  violations: string[];
  capability_surface: 'fixed_pricing_model_config';
};
...
function validateInput(input: Phase6BFixedPricingModelInput): string[] {
  ...
  if (input.source_seed_id !== undefined && input.source_seed_id !== 'seed_6b_02_fixed_pricing_model') {
...
export class Phase6BFixedPricingModelConfig {
  evaluateFixedPricingModel(input: Phase6BFixedPricingModelInput): Phase6BFixedPricingModelResult {
