...
export type Phase6BProductStatusArchivePolicyInput = {
  ...
  product_id: string;
  source_seed_id?: 'seed_6b_01_product_status_archive_policy';
...
export type Phase6BProductStatusArchivePolicyResult = {
  accepted: boolean;
  normalized_status: Phase6BProductStatus;
  emitted_event: Phase6BProductStatusEventType;
  evidence: {
    seed_id: 'seed_6b_01_product_status_archive_policy';
  ...
  capability_surface: 'product_status_archive_policy';
};
...
function validateInput(input: Phase6BProductStatusArchivePolicyInput): string[] {
  ...
  if (input.source_seed_id !== undefined && input.source_seed_id !== 'seed_6b_01_product_status_archive_policy') {
...
export class Phase6BProductStatusArchivePolicyService {
  evaluateProductStatusArchivePolicy(
    input: Phase6BProductStatusArchivePolicyInput,
  ): Phase6BProductStatusArchivePolicyResult {
