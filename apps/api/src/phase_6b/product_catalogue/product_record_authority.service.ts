...
export type Phase6BProductRecordAuthorityInput = {
  ...
  product_id: string;
  source_seed_id?: 'seed_6b_01_product_record_authority';
...
export type Phase6BProductRecordAuthorityResult = {
  accepted: boolean;
  ...
  evidence: {
    seed_id: 'seed_6b_01_product_record_authority';
  ...
  capability_surface: 'product_record_authority';
};
...
function validateInput(input: Phase6BProductRecordAuthorityInput): string[] {
  ...
  if (input.source_seed_id !== undefined && input.source_seed_id !== 'seed_6b_01_product_record_authority') {
...
export class Phase6BProductRecordAuthorityService {
  evaluateProductRecordAuthority(
    input: Phase6BProductRecordAuthorityInput,
  ): Phase6BProductRecordAuthorityResult {
