...
export const phase6APricingTableEffectiveDatesContract = {
...
export type Phase6APricingTableEffectiveDatesContract = typeof phase6APricingTableEffectiveDatesContract;
