export const facebookPageFormsConnectorModuleManifest = {
  seed_id: 'seed_6b_04_facebook_page_forms_connector',
  component_id: '6B.04',
  capability_surface: 'crm_lead_intake.facebook_page_forms_connector',
