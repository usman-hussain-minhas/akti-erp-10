export const liveChatIntakeModuleManifest = {
  seed_id: 'seed_6b_04_live_chat_intake',
  component_id: '6B.04',
  capability_surface: 'crm_lead_intake.live_chat_intake',
  ...
  owned_data: [
    'live_chat_surface_id',
    'live_chat_session_id',
    'live_chat_transcript_ref',
    'operator_user_id',
    'queue_id',
    'handoff_state',
    'lead_fields',
