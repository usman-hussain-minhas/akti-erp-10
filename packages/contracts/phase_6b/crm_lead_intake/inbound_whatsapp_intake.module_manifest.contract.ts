export const inboundWhatsappIntakeModuleManifest = {
  seed_id: 'seed_6b_04_inbound_whatsapp_intake',
  component_id: '6B.04',
  capability_surface: 'crm_lead_intake.inbound_whatsapp_intake',
