...
export function validatePhase6BProductPriceHistoryRequest(
  request: Phase6BProductPriceHistoryValidationRequest,
): Phase6BProductPriceHistoryValidationReceipt {
...
export function resolvePhase6BProductPriceAsOf(
  request: Phase6BProductPriceHistoryResolutionRequest,
): Phase6BProductPriceHistoryResolutionReceipt {
  const validation = validatePhase6BProductPriceHistoryRequest(request);
