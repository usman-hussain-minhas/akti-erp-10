...
export function validatePhase6BInstallmentPlanRequest(
  request: Phase6BInstallmentPlanRequest,
): Phase6BInstallmentPlanReceipt {
...
export function assertValidInstallmentPlanRequest(request: Phase6BInstallmentPlanRequest): void {
