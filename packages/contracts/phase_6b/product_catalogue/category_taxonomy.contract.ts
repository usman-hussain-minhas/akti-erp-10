export const phase6BCategoryTaxonomySeedId = 'seed_6b_01_category_taxonomy' as const;
export const phase6BCategoryTaxonomyComponentId = '6B.01' as const;
export const phase6BCategoryTaxonomyModuleKey = 'phase-6b.product-catalogue' as const;
...
export type Phase6BCategoryTaxonomyInput = {
  ...
  category_id: string;
  source_seed_id?: typeof phase6BCategoryTaxonomySeedId;
  name: string;
  slug: string;
...
export type Phase6BCategoryTaxonomyEvidence = {
...
export type Phase6BCategoryTaxonomyDecision = {
  accepted: boolean;
  ...
  evidence: Phase6BCategoryTaxonomyEvidence;
  violations: string[];
};
...
export function validatePhase6BCategoryTaxonomyInput(input: Phase6BCategoryTaxonomyInput): string[] {
  ...
  if (input.source_seed_id !== undefined && input.source_seed_id !== phase6BCategoryTaxonomySeedId) {
...
export function buildPhase6BCategoryTaxonomyDecision(
  input: Phase6BCategoryTaxonomyInput,
): Phase6BCategoryTaxonomyDecision {
  const violations = validatePhase6BCategoryTaxonomyInput(input);
