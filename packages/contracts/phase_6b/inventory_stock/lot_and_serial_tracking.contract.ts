...
export function validatePhase6BLotAndSerialTracking(
  request: Phase6BLotAndSerialTrackingRequest,
): Phase6BLotAndSerialTrackingReceipt {
...
export function assertValidLotAndSerialTracking(request: Phase6BLotAndSerialTrackingRequest): void {
