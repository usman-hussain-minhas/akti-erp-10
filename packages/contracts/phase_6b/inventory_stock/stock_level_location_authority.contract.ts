...
export function validatePhase6BStockLevelLocationSnapshot(
  request: Phase6BStockLevelLocationSnapshotRequest,
): Phase6BStockLevelLocationSnapshotReceipt {
...
export function assertValidStockLevelLocationSnapshot(request: Phase6BStockLevelLocationSnapshotRequest): void {
