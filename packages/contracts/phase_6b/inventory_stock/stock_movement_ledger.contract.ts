...
export function recordPhase6BStockMovementLedgerEntry(
  request: Phase6BStockMovementLedgerEntryRequest,
): Phase6BStockMovementLedgerEntryReceipt {
...
export function assertValidStockMovementLedgerEntry(request: Phase6BStockMovementLedgerEntryRequest): void {
